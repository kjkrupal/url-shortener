...
class CloudAssemblyBuilder(
    ...
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        """
        props = CloudAssemblyBuilderProps(asset_outdir=asset_outdir)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"asset_outdir": "assetOutdir"},
)
class CloudAssemblyBuilderProps:
    def __init__(self, *, asset_outdir: typing.Optional[builtins.str] = None) -> None:
